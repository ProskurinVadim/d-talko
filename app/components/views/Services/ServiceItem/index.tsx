...
const ServiceItem:FC<Item> = ({title, description, image}) => {
    return (
        <li className="max-w-[296px] md:max-w-[324px] lg:max-w-[389px] bg-main_inverse rounded-r-xl">
            ...
            <div className="py-6 px-4 md:px-6 md:py-8 lg:px-8">
                ...
                <p className="text-additional border-b border-main_inverse_light pb-8 md:pb-12 text-sm mt-3 lg:mt-4 leading-[120%]">
                    {description}
                </p>
                <ServiceButton />
            </div>
